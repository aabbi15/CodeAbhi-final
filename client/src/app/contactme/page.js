...
export default function Page() {
    ...
    return (
        ...
        <div className=" rounded-lg   bg-gray-900 shadow-black/20 md: md:  backdrop-blur-[30px]">
            ...
            <div class="container my-12 mx-auto md:px-6 bg-gray-900 ">
                <section class="mb-32">
                    ...
                    <div class="container px-6 md:px-12 bg-gray-900">
                        <div
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                                        ...
                                        <div
                                            ...
                                            <div class="align-start flex">
                                                ...
                                                <div class="ml-6 grow">
                                                    <p class="mb-2 font-bold  text-white">LinkedIn Profile</p>
                                                    <p class="    text-neutral-200">
                                                       Abhishek Abbi
                                                    </p>
  ...
  <path d="M178.57 127.15 290.27 0h-26.46l-97.03 110.38L89.34 0H0l117.13 166.93L0 300.25h26.46l102.4-116.59 81.8 116.59h89.34M36.01 19.54H76.66l187.13 262.13h-40.66"/>
                                                ...
                                                <div class="ml-6 grow">
                                                    <p class="mb-2 font-bold  text-white">X profile</p>
                                                    <p class="    text-neutral-200">
                                                        @AbhishekAb70528
                                                    </p>
